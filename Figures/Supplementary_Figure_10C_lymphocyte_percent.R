...
ot_stats <- function_csv("01_opentargts_lymp_percent.csv",
                         gene_col  = "symbol",
...
# 5) 导出结果
data.table::fwrite(fg_res, "fgsea_RBP_regulons_vs_OpenTargets_3UTR_lymphocyte_percent.csv")
data.table::fwrite(fg_res, "fgsea_RBP_regulons_vs_OpenTargets_5UTR_lymphocyte_percent.csv")
data.table::fwrite(fg_res, "fgsea_RBP_regulons_vs_OpenTargets_CDS_lymphocyte_percent.csv")
data.table::fwrite(fg_res, "fgsea_RBP_regulons_vs_OpenTargets_Introns_lymphocyte_percent.csv")
...
## -------- dotplot for regulon–OpenTargets enrichment (dataset #3) --------
txt <- "Regulon\tNES\tlogp\tpadj
DDX3X_3UTR\t1.148492148\t0.781732568\t0.716291058
TAF15_3UTR\t0.874545448\t0.147551468\t0.771277458
QKI_5UTR\t1.280742764\t2.838636341\t0.023199768
HNRNPC_5UTR\t1.23502713\t2.012785113\t0.04103959
DDX3X_5UTR\t1.25286491\t1.988856982\t0.04103959
PUM1_5UTR\t1.256246829\t1.579215037\t0.084320843
TNRC6C_5UTR\t1.216624356\t1.281410937\t0.11956691
NIPBL_5UTR\t1.126623086\t0.723388573\t0.37813025
RBM47_Introns\t1.361267811\t1.940615561\t0.17197911
HNRNPC_Introns\t0.984468805\t0.25825413\t0.974052755
DEK_Introns\t0.833783455\t0.073169553\t0.974052755
PUM1_CDS\t0.749660416\t0.045376462\t0.900789963
YTHDF3_3UTR\t1.037481703\t0.379151646\t0.771277458
DDX21_3UTR\t1.167369989\t0.870831464\t0.716291058
TRA2A_3UTR\t1.046290713\t0.404437623\t0.771277458
"
