...
regulon_id <- "RBFOX2_3'UTR"
out_dir <- "RBFOX2_3'UTR_dev_boxplot"

regulon_id <- "HMGB2_Intron"
out_dir <- "HMGB2_Intron_dev_boxplot"


regulon_id <- "ZFP36_3'UTR"
out_dir <- "ZFP36_3'UTR_dev_boxplot"


regulon_id <- "IGF2BP2_3'UTR"
out_dir <- "IGF2BP2_3'UTR_dev_boxplot"
