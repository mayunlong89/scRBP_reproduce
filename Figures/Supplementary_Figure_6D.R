# --- 2026-03-05
# E-statistic assessment of MAGMA window sizes across 9 aging-related traits
...
# 2) Reshape to long format and standardize region names
long <- df %>%
  pivot_longer(
    cols = -window_size,
...
# 3) Single color for all elements
col_single <- "#C47BA6"

# 4) Plot: boxplot + jittered points (shape by mRNA region)
