...
infile <- "01_heatmap_8braindiseases_Wangli_validation.csv"  # <- 改成你的文件路径
...
cell_type <- dplyr::recode(cell_type_raw, !!!map_vec, .default = cell_type_raw)
...
# =========================
reds <- colorRampPalette(rev(c("firebrick3","#E77A77","#ECBA84","white","lightblue","#336699")))(102)
